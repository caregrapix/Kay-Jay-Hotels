          ...
          <div className="hidden md:flex items-center space-x-6">
            <ul className="flex items-center space-x-6 font-medium">
              ...
              >
                ...
                >
                  <div className="mt-2 w-[50rem] max-w-screen-lg bg-white rounded-lg shadow-xl border border-gray-100">
                    <div className="grid grid-cols-3 gap-6 p-8">
                          ...
                          {sortedHotels.map(hotel => (
                            <li key={hotel.id}>
                              <Link 
                                ...
                                className="font-semibold text-brand-dark hover:text-brand-primary transition-colors duration-300 flex items-center"
                      ...
                      <div className="col-span-1">
                        ...
                        <ul className="space-y-3">
                          ...
                          <li>
                           ...
                           <li>
                            <Link to="/hotels/kayjay-amorea" onClick={() => setIsDropdownOpen(false)} className="text-gray-600 hover:text-brand-primary">Coastal Relaxation</Link>
                          </li>
                        </ul>
                      </div>
                      ...
                      <div className="col-span-1 flex flex-col">
                         ...
                         <Link to={`/hotels/${featuredHotel.slug}`} onClick={() => setIsDropdownOpen(false)} className="group block rounded-lg overflow-hidden relative flex-grow">
