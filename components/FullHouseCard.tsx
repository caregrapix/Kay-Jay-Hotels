            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
               ...
               <div className="md:col-span-2">
                 <label htmlFor={`payment-method-full-${room.id}`} className={labelClasses}>Payment Method</label>
                 <select id={`payment-method-full-${room.id}`} value={paymentMethod} onChange={e => setPaymentMethod(e.target.value)} className={inputClasses}>
