...
// Placeholder logos for OTAs
const BookingLogo = () => (
    <img src="/public/images/booking-logo.png" alt="Booking.com" className="h-6" />
);

const AgodaLogo = () => (
    <img src="/public/images/agoda-logo.png" alt="Agoda" className="h-6" />
);

const ExpediaLogo = () => (
    <img src="/public/images/expedia-logo.png" alt="Expedia" className="h-6" />
);
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="mt-2 text-brand-primary italic text-sm">Luxury in every detail</p>
             ...
             <div className="mt-8">
                <h4 className="text-sm font-semibold uppercase tracking-wider mb-3 text-gray-400">Find Us On</h4>
                <div className="flex items-center space-x-6 text-gray-300">
                    <div className="filter grayscale hover:grayscale-0 transition duration-300"><BookingLogo /></div>
                    <div className="filter grayscale hover:grayscale-0 transition duration-300"><AgodaLogo /></div>
                    <div className="filter grayscale hover:grayscale-0 transition duration-300"><ExpediaLogo /></div>
                </div>
            </div>
          </div>
          ...
          {/* Popular Amenities */}
          <div>
            <h4 className="text-lg font-semibold uppercase tracking-wider mb-4 text-brand-primary">Popular Amenities</h4>
            <ul className="space-y-2 text-gray-300">
              <li><Link to="/hotels/kayjay-amorea" className="hover:text-brand-primary transition-colors">Swimming Pool</Link></li>
              ...
              <li><Link to="/hotels/kayjay-amorea" className="hover:text-brand-primary transition-colors">Weddings & Events</Link></li>
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-lg font-semibold uppercase tracking-wider mb-4 text-brand-primary">Quick Links</h4>
            <ul className="space-y-2 text-gray-300">
          ...
          {/* Properties */}
           <div>
            <h4 className="text-lg font-semibold uppercase tracking-wider mb-4 text-brand-primary">Our Properties</h4>
            <ul className="space-y-2 text-gray-300">
          ...
          {/* Contact */}
          <div>
            <h4 className="text-lg font-semibold uppercase tracking-wider mb-4 text-brand-primary">Contact Us</h4>
