...
const PropertyPage: React.FC = () => {
  ...
  const hotelSchema = {
    ...
    "image": hotel.images.map(img => `https://kayjayhotels.com${img}`),
    "starRating": {
      "@type": "Rating",
    ...
    "url": `https://kayjayhotels.com/hotels/${hotel.slug}`,
            ...
            <AnimatedSection>
              <header>
                 <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
                    <div>
                        <h1 className="text-4xl md:text-5xl font-sans font-bold text-brand-dark">{hotel.name}</h1>
          ...
          <aside className="lg:col-span-1">
            <div className="lg:sticky lg:top-28 space-y-8">
              <AnimatedSection>
                ...
                <AnimatedSection>
                  <div className="bg-white p-6 rounded-lg shadow-md border border-gray-200/80">
                    <h3 className="text-2xl font-bold font-sans text-brand-dark mb-4">Good to know</h3>
