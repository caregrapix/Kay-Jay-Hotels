...
const PrivacyPolicyPage: React.FC = () => {
  return (
    <>
      <PageMetadata
        title="Privacy Policy | Luxury in Every Detail | Kayjay Hotels"
        description="Read the privacy policy for Kayjay Hotels. We are committed to protecting your personal information and being transparent about the technology we use and what we do with your data."
      />
      <div className="bg-brand-gray py-20">
        <div className="container mx-auto px-6">
          <AnimatedSection>
            <div className="max-w-4xl mx-auto bg-white p-10 rounded-lg shadow-md">
              <h1 className="text-3xl md:text-4xl font-sans font-bold text-brand-dark mb-6">Privacy Policy</h1>
              <div className="text-gray-700 leading-relaxed space-y-6">
                <p><strong>Last Updated:</strong> {new Date().toLocaleDateString()}</p>

                <h2 className="text-xl font-bold text-brand-dark pt-4">1. Introduction</h2>
                ...
                <h2 className="text-xl font-bold text-brand-dark pt-4">2. Information We Collect</h2>
                ...
                <h2 className="text-xl font-bold text-brand-dark pt-4">3. How We Use Your Information</h2>
                ...
                <h2 className="text-xl font-bold text-brand-dark pt-4">4. Third-Party Services and Data Processing</h2>
                ...
                <h2 className="text-xl font-bold text-brand-dark pt-4">5. Data Security & Retention</h2>
                ...
                <h2 className="text-xl font-bold text-brand-dark pt-4">6. Your Rights</h2>
                ...
                <h2 className="text-xl font-bold text-brand-dark pt-4">7. Contact Us</h2>
