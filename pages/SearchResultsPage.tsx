...
const SearchResultsPage: React.FC = () => {
  ...
  if (query) {
    ...
    return (
      <>
        <PageMetadata
          title={`Search Results for "${query}" | Kayjay Hotels`}
          description={`Find hotels, rooms, and content matching your search for "${query}".`}
        />
  ...
  if (hotelSlug) {
    ...
    return (
      <>
        <PageMetadata
          title={`Availability at ${hotel.name} | Luxury in Every Detail | Kayjay Hotels`}
          description={`Check room availability for your stay at ${hotel.name}.`}
        />
        <div className="bg-brand-gray py-20">
