...
const ContactUsPage: React.FC = () => {
  ...
  const pageSchema = {
    ...
    '@type': 'ContactPage',
    name: 'Contact Us | Kayjay Hotels',
    url: 'https://kayjayhotels.com/contact',
    description:
      'Get in touch with Kayjay Hotels. Find our contact details, office address, and send us an inquiry. We look forward to hearing from you.',
  };
  ...
  return (
    <>
      <PageMetadata
        title="Contact Us | Luxury in Every Detail | Kayjay Hotels"
        description="Get in touch with Kayjay Hotels. Find our contact details, office address, and send us an inquiry. We look forward to hearing from you."
        jsonLd={pageSchema}
      />
        ...
        <div className="container mx-auto px-6 py-20">
          <AnimatedSection>
            <div className="text-center mb-12">
              <h1 className="text-4xl md:text-5xl font-sans font-bold text-brand-dark">
                Get In Touch
              </h1>
          ...
          <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <AnimatedSection>
              <div className="bg-white p-8 rounded-lg shadow-lg">
                ...
                {formStatus === 'success' ? (
                  <div className="flex flex-col items-center justify-center text-center bg-green-50 p-6 rounded-lg">
                  ...
                  <form onSubmit={handleSubmit} noValidate className="space-y-6">
                    <div>
                      ...
                      <input
                        ...
                        className={`mt-1 w-full text-base px-4 py-3 border rounded-md focus:ring-brand-primary focus:border-brand-primary ${
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={handleChange}
                        className="mt-1 w-full text-base px-4 py-3 border border-gray-300 rounded-md focus:ring-brand-primary focus:border-brand-primary"
                      />
                    </div>
                    <div>
                      <label
                    ...
                    <div>
                      <button
                        ...
                        className="w-full bg-brand-primary text-white font-bold py-3 px-6 rounded-md hover:bg-brand-dark transition-all duration-300 disabled:bg-gray-400 disabled:cursor-not-allowed"
                      >
