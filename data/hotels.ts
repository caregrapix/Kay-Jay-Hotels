...
export const hotelsData: Hotel[] = [
  {
    ...
    name: 'KayJay Amorea',
    slug: 'kayjay-amorea',
    tagline: 'Your Serene Coastal Retreat',
    ...
    seoTitle: 'KayJay Amorea | Beachfront Hotel in Wattala, Sri Lanka',
    seoDescription: 'Discover KayJay Amorea, one of the premier beach hotels in Uswetakeiyawa, Wattala. Our coastal hotel near Colombo Airport offers stunning sea views, a serene pool, and direct beach access.',
    location: '100E Bopitiya Road, Uswetakeiyawa 11328, Wattala, Sri Lanka',
    searchableAmenities: ['swimming pool', 'beach access', 'restaurant', 'bar', 'wifi', 'parking', 'weddings', 'events', 'air conditioning', 'hot water', 'sea view', 'coastal hotel', 'hotel in Uswetakeiyawa', 'beach hotel'],
    images: [
